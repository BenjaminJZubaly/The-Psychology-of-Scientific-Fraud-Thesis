...
Although the follwing may not represent the actual variable names in the final study dataset, the following abbreviations will be used to refer to study variables in the code:
...
I am also going to document here the processes of simple steps that I will follow while doing the analysis, because I am a novice.
...
In order to further explore data characteristics, bivariate correlations between outcome variables will be produced. As these are only for exploring data and not testing predictions, assumptions will not be tested, and the relationships will not be probed for statistical significance.

1.  Pearson bivariate correlations will produced for `LingObf`, `CertSent`, and `Refs`.
...
**Hypothesis 3:** Fraudulent research will contain more certainty sentiment than non-fraudulent research. \[Replication\]
